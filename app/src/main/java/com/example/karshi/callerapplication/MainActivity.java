package com.example.karshi.callerapplication;
...
public class MainActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.menuAdd:
                Intent intent = new Intent(MainActivity.this, Add_a_contact.class);
        ...
        switch (requestCode){
            ...
            case 1024:
                if(resultCode== Activity.RESULT_OK){
                    ...
                    if(data.hasExtra(Add_a_contact.CONTACTTOKEN)){

                        String msg= data.getStringExtra(Add_a_contact.CONTACTTOKEN);
